...
- The device is given a moment to settle after the connection is up before it is asked for a reading, and a request that is not answered at all is repeated rather than waiting out the whole timeout.
